...
vec3 RandomPointOnTriangle(Vertex v1, Vertex v2, Vertex v3)
{
    
}

vec3 TriangleArea(Vertex v1, Vertex v2, Vertex v3)
{

}

uint SelectRandomEmissiveTriangle(uint seed)
{
